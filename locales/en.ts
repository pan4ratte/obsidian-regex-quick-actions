export default {
    ...
    PLACEHOLDER_FLAGS: "For example: gm",
    ...
    TAB_SEQUENCES: "Action sequences",
    /* Shown in place of the two above when the tab strip runs out of room. */
    TAB_ACTIONS_SHORT: "Actions",
    TAB_SEQUENCES_SHORT: "Sequences",
    NO_ACTIONS_YET: "No quick actions yet. Create one to run it from the command palette.",
    NO_SEQUENCES_YET: "No action sequences yet. A sequence runs several quick actions one after another.",
    ...
    NOT_FOUND_ERR: "Quick action '{}' not found!",
